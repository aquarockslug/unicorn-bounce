...
settings = {
	...
	backgroundSchemes: [
		{ color1: '#4a2540', color2: '#2f3a56' },
		{ color1: '#0f2027', color2: '#162a36' },
		{ color1: '#2f202c', color2: '#3a2f2a' },
		{ color1: '#14281c', color2: '#1f3a2e' },
		{ color1: '#19162f', color2: '#2b2150' },
		{ color1: '#1c232b', color2: '#2b3742' },
	],
